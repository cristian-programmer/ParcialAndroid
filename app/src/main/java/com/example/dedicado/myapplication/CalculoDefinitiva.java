...
public class CalculoDefinitiva extends AppCompatActivity implements OnClickListener {
    EditText asignatura1, asig_nota1, asig_nota2, asig_nota3;
    Button asig1_calcular;
    TextView asig1_resultado;


    EditText asignatura2, asig2_nota1, asig2_nota2, asig2_nota3;
    Button asig2_calcular;
    TextView asig2_resultado;

    EditText asignatura3, asig3_nota1, asig3_nota2, asig3_nota3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculo_definitiva);
        ...
        asig_nota3 = (EditText) findViewById(R.id.asig1_nota3);
        ...
        asig2_nota3 = (EditText) findViewById(R.id.asig2_nota3);
        ...
        asig3_nota3 = (EditText) findViewById(R.id.asig3_nota3);
       ...
       // switch (v.getId()){
            ...
            if( id==R.id.asig1_calcular) {
                ...
                if (asignatura.length() > 5 && asignatura.length() < 14) {
                    ...
                    String nota3 = asig_nota3.getText().toString();


                    if(!nota1.isEmpty()  && !nota2.isEmpty() && !nota3.isEmpty() ){
                        double valor2 = Double.valueOf(nota2);
                        double valor1 = Double.valueOf(nota1);
                        double valor3 = Double.valueOf(nota3);

                        double resultado= ((valor1 * PORCENTAJE1) + (valor2 * PORCENTAJE2)+ (valor3 * PORCENTAJE3));
                        String resultadofinal = "Nota Definitiva Es: "+String.valueOf(resultado);
                        asig1_resultado.setText(resultadofinal);
                    }else{
                        Toast.makeText(this,"Ingrese la nota 1 o la nota 2 o nota 3 ",Toast.LENGTH_LONG).show();
                    }
            ...
            if(id==R.id.asig2_calcular){
                ...
                if( asignatura_2.length() > 5 && asignatura_2.length() < 14){
                    ...
                    String nota3 = asig2_nota3.getText().toString();
            ...
            if(id==R.id.asig3_calcular){
                ...
                if( asignatura_3.length() > 5 && asignatura_3.length() < 14){
                    ...
                    String nota3 = asig3_nota3.getText().toString();
